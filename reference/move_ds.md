...
out$files
#> [1] "/tmp/RtmpeY9pOd/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/RtmpeY9pOd/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/RtmpeY9pOd/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/RtmpeY9pOd/mrgsims-ds-1953362f5834.parquet"
```
