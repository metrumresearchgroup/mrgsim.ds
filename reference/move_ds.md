...
out$files
#> [1] "/tmp/RtmpILZqaI/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/RtmpILZqaI/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/RtmpILZqaI/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/RtmpILZqaI/mrgsims-ds-1a8166add28a.parquet"
```
