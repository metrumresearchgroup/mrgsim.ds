...
out$files
#> [1] "/tmp/Rtmp3O4cDz/mrgsims-ds-new-name-1.parquet"
#> [2] "/tmp/Rtmp3O4cDz/mrgsims-ds-new-name-2.parquet"
#> [3] "/tmp/Rtmp3O4cDz/mrgsims-ds-new-name-3.parquet"

out <- combine_ds(out)

out$files
#> [1] "/tmp/Rtmp3O4cDz/mrgsims-ds-1a0b7ef867b6.parquet"
```
