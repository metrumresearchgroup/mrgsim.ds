...
- [`mrgsim.ds-package`](https://p-emex.github.io/mrgsim.ds/reference/mrgsim.ds.md)
  [`mrgsim.ds`](https://p-emex.github.io/mrgsim.ds/reference/mrgsim.ds.md)
...
- [`dim(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-methods.md)
  ...
  [`plot(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-methods.md)
  : Interact with mrgsimsds objects
- [`print(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/print.mrgsimsds.md)
  : Print an mrgsimsds object
- [`group_by(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`select(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`mutate(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`filter(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`arrange(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`rename(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`summarise(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`distinct(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`relocate(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`count(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
  [`pull(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/mrgsimsds-verbs.md)
...
- [`current_location()`](https://p-emex.github.io/mrgsim.ds/reference/current_location.md)
...
- [`is_mrgsimsds()`](https://p-emex.github.io/mrgsim.ds/reference/is_mrgsimsds.md)
  : Check if object inherits mrgsimsds

## Coerce output to an R object

- [`as_tibble(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/as_tibble.mrgsimsds.md)
  [`collect(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/as_tibble.mrgsimsds.md)
  [`as.data.frame(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/as_tibble.mrgsimsds.md)
...
- [`as_arrow_table(`*`<mrgsimsds>`*`)`](https://p-emex.github.io/mrgsim.ds/reference/as_arrow_table.mrgsimsds.md)
